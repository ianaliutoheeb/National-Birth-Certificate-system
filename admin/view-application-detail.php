...
<head>
    ...
    <title>Manage Application Form | National Birth Registration and Certification System</title>
...
<td colspan="4" style="font-size:20px;color:red">
 Application Number:   <?php  echo $row->ApplicationID;?></td></tr>
    ...
    <th scope>Administrator Name</th>
    <td><?php  echo $row->LastName;?></td>
  </tr>
  <tr>
    <th scope>CAC Number</th>
...
<td colspan="4" style="font-size:20px;color:blue">
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
<th scope>Parent Permanent Address</th>
