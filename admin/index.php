...
<head>
    ...
    <title>Login | National Birth Registration and Certification System</title>
                            ...
                            <div class="col-lg-4">
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                            <img src="img/Nigeria Coat of Arm.png" alt="">
                                                <h3 style="font-weight: bold;color: blue">National Birth Registration and Certification System</h3>
                                                <hr />
                                            </div>
                                        </div>
                                    </div>
